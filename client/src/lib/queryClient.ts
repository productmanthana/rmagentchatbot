...
// NOTE: The URL 'token' param is the JWT, NOT the embedToken
// The embedToken is generated by the server and stored in sessionStorage
function getEmbedToken(): string | null {
  try {
    // Get embedToken from sessionStorage (set after session creation)
